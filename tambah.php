    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <a href="index.php?p=tambah">
                <h4 class="active">Tambah Karyawan</h4>
            </a>
            </div>
        </div>
        ...
        <div class="content">
            <div class="container animated rollIn">
                ...
                <div class="form">
                    <table>
                        <tr>
                            <form action="index.php?p=proses_tambah" method="post" id="form" enctype="multipart/form-data">
                                <td>
                                    <div class="card">
                                ...
                                <td>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <br/>
                                        <input class="input-form" type="text" name="tempat" id="tempat">
                                        <br/>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <br/>
                                        <input class="input-form" type="date" data-date-format="DD MMMM YYYY" name="tanggal" id="tanggal">
                                        <br/>
                                    </div>
